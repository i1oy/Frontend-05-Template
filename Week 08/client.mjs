...
class ChunkedBodyParser {
    ...
    receiveChar(ch) {
        if (this.current === this.WAITING_LENGTH) {
            ...
            if (ch === "\r") this.current = this.WAITING_NEW_LINE_END;
    ...
    receiveChar(ch) {
        if (this.current === this.WAITING_STATUS_LINE) {
            if (ch === "\r") {
                ...
                this.statusCode = this.statusLine.split(" ")[1];
                console.log("STATUES CODE: ", this.statusCode);
            } else {
                this.statusLine += ch;
            }
            ...
            if (ch === " ") this.current = this.WAITING_HEADER_VALUE;
